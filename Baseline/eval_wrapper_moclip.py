...
# ---------------------------
# Gaussian RBF 核下的 MMD 计算函数（针对 motion embedding）
# ---------------------------
...
def _init_clip_motion_model(model_path):
    """
    仅在全局缓存为空时，初始化 CLIP 模型、tokenizer、MotionEncoder 并加载预训练权重
    """
...
# 获取文本与动作编码的接口
# ---------------------------
def get_co_embeddings_2(captions, motions, model_path="clip_motion_align_epoch_18.pt"):
    """
    获取文本与动作的编码
