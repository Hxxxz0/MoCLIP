...
if __name__ == '__main__':
    ...
    all_metrics = evaluation(eval_wrapper, gt_loader, eval_motion_loaders, log_file, opt.replication_times, opt.diversity_times, opt.mm_num_times,device = device, run_mm=True,)
